                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="{{ route('admin.users.edit', $user) }}"><i class="bi bi-pencil-square icon-edit icon-button"></i></a>
                                                <a href="{{ route('admin.users.deletePreview', $user) }}"><i class="bi bi-trash icon-delete icon-button"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
