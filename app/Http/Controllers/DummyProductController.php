<?php
    ...
    class DummyProductController extends Controller
    {
        public function index(Request $request)
        {
            ...
            $savedProducts = Product::with('category')->where('izvor', 'servis')->get()->mapWithKeys(
                function ($product) {
            ...
            $paginator = new LengthAwarePaginator(
                ...
                $perPage,
                $page,
                ['path' => route('dummy.products'), 'query' => $request->query()]
            );
        ...
        public function store(Request $request)
        {
            ...
            $category = Category::firstOrCreate(
                [
                    ...
                    'opis' => "Kategorija dohvačena sa Dummy servisa"
                ]
            );
            ...
            if ($product->wasRecentlyCreated) {
                return redirect()->route('dummy.products')->with('success', "Proizvod je uspješno spremljen iz servisa");
            }

            return redirect()->route('dummy.products')->with('success', "Proizvod je već ranije spremljen");
        }
    }
